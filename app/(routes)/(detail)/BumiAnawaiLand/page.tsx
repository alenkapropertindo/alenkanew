            ...
            <div className="mt-5 px-2 sm:mt-16 sm:px-0 lg:mt-0">
              <div>
                ...
                <p className="text-sm  text-gray-900 p-1">
                  Perumahan Bumi Anawai Land adalah perumahan yg terletak
                ...
                <p className="text-sm  text-gray-900 p-1">
                  1. Hanya 12 menit ke kampus Universitas Muhamadiyah Kendari
                </p>
                <p className="text-sm  text-gray-900 p-1">
                  2. Hanya 8 menit ke Pasar panjang
                </p>
                <p className="text-sm  text-gray-900 p-1">
                  3. Hanya 9 menit Ke RSU Hermina
                </p>
                <p className="text-sm  text-gray-900 p-1">
                  4. Hanya 6 menit ke Polres Kota Kendari
                </p>
                <p className="text-sm  text-gray-900 p-1">
                  5. Hanya 15 menit ke Lippo Plaza Kendari
                </p>
                <p className="text-sm  text-gray-900 p-1">
                ...
                <div className="mt-5 flex items-center gap-x-3">
                  <Link
                    ...
                    href="https://wa.me/6285242049550?text=Halo, Saya minat perumahan Bumi Anawai Land"
                  >
                    Hubungi Admin
                  ...
                  <Link
                    className=" w-full text-xs  px-0 justify-center flex font-semibold text-slate-800  border-2 border-slate-800 hover:text-white hover:bg-slate-800 py-2 rounded-md tracking-wider transition "
                    href="https://maps.app.goo.gl/qiyG8zo1Mmi5wzM16"
                  >
                    Check Map
