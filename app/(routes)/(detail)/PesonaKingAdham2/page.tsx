                      ...
                      <div>
                        <span className="absolute h-full w-full aspect-square inset-0 overflow-hidden rounded-md">
                          <Image
                            ...
                            src="/PESONA KING ADHAM 2.jpg"
                            width={200}
                            height={200}
                            alt="Pesona King Adham 2"
                          />
                        </span>
                        <span
                          className={cn(
            ...
            <div className="mt-5 px-2 sm:mt-16 sm:px-0 lg:mt-0">
              <div>
                ...
                <p className="text-sm  text-gray-900 p-1">
                  Perumahan Pesona King Adham residence merupakan Perumahan
                  Subsidi yg memiliki vibes rumah komersil, selain karena desain
                  elegan yg tdk pasaran perumahan ini jg terletak di lokasi yg
                  sangat strategis, yaitu di tepi jalan Poros utama 2jalur
                  THR-Puuwatu, jalan perumahan nya sdh menggunakan paving blok.
                  Adapun keunggulan lain dr perumahan ini yaitu:
                </p>
                <p className="text-sm  text-gray-900 p-1">
                  1. Angsuran ringan cm 1 jutaan dan flat sampai lunas
                </p>
                <p className="text-sm  text-gray-900 p-1">
                ...
                <div className="mt-5 flex items-center gap-x-3">
                  <Link
                    ...
                    href="https://wa.me/6285242049550?text=Halo, Saya minat perumahan Pesona King Adham 2"
                  >
                    Hubungi Admin
                  ...
                  <Link
                    className=" w-full text-xs  px-0 justify-center flex font-semibold text-slate-800  border-2 border-slate-800 hover:text-white hover:bg-slate-800 py-2 rounded-md tracking-wider transition "
                    href="https://maps.app.goo.gl/b3cZP4JTaSVNu2En7"
                  >
                    Check Map
